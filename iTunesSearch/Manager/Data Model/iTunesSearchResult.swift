...
class MusicResult: NSObject, Codable, NSCoding {
    ...
    init(wrapperType: String?, kind: String?, artistId: Int?, trackId: Int?, artistName: String?, trackName: String?, trackViewUrl: String?, previewUrl: String?, artworkUrl100: String?, releaseDate: String?, country: String?, primaryGenreName: String?) {
    ...
    convenience init?(dictionary: [String: Any]) {
        ...
        self.init(wrapperType: wrapperType, kind: kind, artistId: artistId, trackId: trackId, artistName: artistName, trackName: trackName, trackViewUrl: trackViewUrl, previewUrl: previewUrl, artworkUrl100: artworkUrl100, releaseDate: releaseDate, country: country, primaryGenreName: primaryGenreName)
    }
